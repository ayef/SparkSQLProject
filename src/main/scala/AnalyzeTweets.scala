...
created_at_second: Int*/)
	def main(args: Array[String]) {
		...
		val tweet =  sc.textFile("tweetsDB.txt").map(_.split("\t")).map(t => Tweet( t(4), t(9), t (10), t(11), t(12), t(13), t(14), t(15), t(16), t(17)) )
		println(tweet.count())
		tweet.registerAsTable("tweet")
		...
		//fromCountries.map(col => "name: " + col(0) + " loc: " + col(1) + " count: " + col(2)  ).collect().foreach(println)
